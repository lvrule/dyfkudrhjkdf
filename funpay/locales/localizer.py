...
class Localizer:
    def __new__(cls, curr_lang: Union[str, None] = None):
    ...
    def translate(self, variable_name: str, *args, language: Union[str, None] = None):
        """
    ...
    def plugin_translate(self, uuid: str, variable_name: str, *args, language: Union[str, None] = None):
