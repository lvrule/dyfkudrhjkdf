...
class WithdrawError(RequestFailedError):
    ...
    def __init__(self, response, error_message: Union[str, None]):
...
class RaiseError(RequestFailedError):
    ...
    def __init__(self, response, category: types.Category, error_message: Union[str, None], wait_time: Union[int, None]):
...
class ImageUploadError(RequestFailedError):
    ...
    def __init__(self, response: requests.Response, error_message: Union[str, None]):
...
class MessageNotDeliveredError(RequestFailedError):
    ...
    def __init__(self, response: requests.Response, error_message: Union[str, None], chat_id: int):
...
class FeedbackEditingError(RequestFailedError):
    ...
    def __init__(self, response: requests.Response, error_message: Union[str, None], order_id: str):
...
class LotParsingError(RequestFailedError):
    ...
    def __init__(self, response: requests.Response, error_message: Union[str, None], lot_id: int):
...
class LotSavingError(RequestFailedError):
    ...
    def __init__(self, response: requests.Response, error_message: Union[str, None], lot_id: int, errors: Dict[str, str]):
