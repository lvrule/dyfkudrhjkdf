...
def get_tags(current_tag: str) -> Optional[List[str]]:
    """
...
def get_releases(from_tag: str) -> Optional[List[Release]]:
    """
...
def get_new_releases(current_tag) -> Union[int, List[Release]]:
    """
...
def extract_update_archive() -> Union[str, int]:
    """
